...
export class AICallAgent {
  ...
  async initialize() {
    try {
      ...
      // Set default script if none found
      if (!this.customScript) {
        this.customScript = `
          You are a professional sales agent.
          Be friendly and concise in your responses.
          Focus on qualifying the lead and understanding their needs.
          Keep responses brief and natural.
          Never mention being an AI.
        `.trim();
        this.debug('Using default script');
      }
